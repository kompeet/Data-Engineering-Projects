...
github as (
    ...
    select
        ...
        timestamp_trunc(g.created_at_datetime_utc, month) as first_day_of_period,
...
final as (
    ...
    on d.date_month = extract(datetime from g.first_day_of_period) and d.organization_name = g.organization_name
